...
{
    const uint8_t generator = 0xE5; // Reflected polynomial of 0xA7
    uint8_t crc = 0;
...
int main()
{
    ...
    // Generate tables
    auto table = GenerateCRCTable(0xA7);
    auto table_reflected = GenerateCRCTable_Reflected(0xE5);
